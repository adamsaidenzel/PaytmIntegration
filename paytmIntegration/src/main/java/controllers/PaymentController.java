...
public class PaymentController {
    ...
    public Map<String, Object> startPayment(
        ...
        try {
            ...
            /* for Staging */
            URL url = new URL("https://securegw.paytm.in/theia/api/v1/initiateTransaction?mid=" + AppConfig.MID + "&orderId=" + orderId + "");
           // https://securegw.paytm.in/theia/api/v1/initiateTransaction?mid=YOUR_MID_HERE&orderId=ORDERID_98765
